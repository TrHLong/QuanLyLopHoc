        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDataExported = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 9, 11, 16, 38, 14, 634, DateTimeKind.Utc).AddTicks(9340), "teacher@example.com", "Giáo viên Toán", true, null, "$2a$11$MNmpZXa8Z.SElWzlQ3C3LeEIhRQM8vRr64gtg4DBnobvf9TMcNG0G", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_StudentId_CourseId_Date_TimeSlot",
                table: "Attendances",
                columns: new[] { "StudentId", "CourseId", "Date", "TimeSlot" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_Grade_TimeSlot_StartDate",
                table: "Courses",
                columns: new[] { "Grade", "TimeSlot", "StartDate" },
                unique: true);
